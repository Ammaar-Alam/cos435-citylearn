...
from cos435_citylearn.baselines.mappo import run_mappo
...
def main() -> None:
    ...
    parser.add_argument(
        "--config",
        default="configs/train/mappo/mappo_shared_ctde_reward_v2.yaml",
    ...
    parser.add_argument("--split", default=None, help="override env.split")
    parser.add_argument(
        "--artifact-id",
        default=None,
        help="run_id of an existing MAPPO run to re-evaluate without training",
    )
    ...
    parser.add_argument("--ent-coef", type=float, default=None, help="override training.ent_coef")
    ...
    parser.add_argument(
        ...
        action="store_true",
        help="opt into evaluating a checkpoint whose runtime labels do not match the config",
    )
