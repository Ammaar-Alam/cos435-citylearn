...
def main() -> None:
    ...
    parser.add_argument(
        "--config",
        default="configs/train/td3/td3_central_baseline.yaml",
    ...
    parser.add_argument(
        "--artifact-id",
        default=None,
        help="run_id of an existing TD3 checkpoint to re-evaluate without training",
    )
    parser.add_argument(
        "--checkpoint-path",
        default=None,
        help="local shared TD3 checkpoint.pt to re-evaluate without training",
    )
    parser.add_argument(
        "--seed",
        type=int,
