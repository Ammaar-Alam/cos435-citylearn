...
\begin{itemize}
    \item SAC with a reward aligned to the official scoring terms reduces the RBC composite score by 48.4\% on the local evaluation dataset and by 40\% on the released held-out phase-2 splits; in the same-topology phase-2 setting, checkpoint ensembling further reduces the best SAC-family score to 0.616.
