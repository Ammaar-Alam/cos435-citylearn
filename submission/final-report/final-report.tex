...
\paragraph{TD3 learning-rate screen.}
...
\paragraph{Local-to-held-out comparison.}
...
\paragraph{PPO training diagnostic.} The centralized PPO baseline learning curve rises early and then plateaus, confirming that PPO learned a nontrivial policy before the final multiseed comparisons in Tables~\ref{tab:local} and~\ref{tab:final_matrix}.
