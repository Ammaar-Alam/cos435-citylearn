...
def test_sac_runners_are_launchable_and_checkpoint_evaluable() -> None:
    ...
    assert RUNNERS["sac_shared_residual_adaptive_reward_v2"].launchable is True
    assert RUNNERS["sac_shared_residual_adaptive_reward_v2"].supports_checkpoint_eval is True
...
def test_td3_runners_are_launchable_and_checkpoint_evaluable() -> None:
    assert RUNNERS["td3_central_baseline"].launchable is True
